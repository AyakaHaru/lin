...
data_ip="https://raw.githubusercontent.com/Eritsuu/vino/main/vin"
checking_sc() {
  ...
  if [[ $date_list < $useexp ]]; then
    ...
    echo -e "      ${GREEN}TELEGRAM${NC} t.me/Eritsuu"
    echo -e "\033[1;93m────────────────────────────────────────────\033[0m"
    exit 0
  fi
}
...
echo -e "${purple}----------------------------------------------------------${NC}"
echo -e " ›AUTHOR : ${green}ERITSU VPN ${NC}${YELLOW}(${NC}${green}V 3.0${NC}${YELLOW})${NC}"
echo -e " ›TEAM 𝕰𝕽𝕽𝕺𝕽 404${YELLOW}(${NC} 2023 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/AyakaHaru/lin/main/"
...
echo -e "\e[32mloading...\e[0m" 
clear
izinsc="https://raw.githubusercontent.com/Eritsuu/vino/main/vin"
# USERNAME
rm -f /usr/bin/user
...
echo ""
echo "" | tee -a log-install.txt
echo "Jangan lupa untuk bersyukur dimanapun anda berada"
sleep 1
